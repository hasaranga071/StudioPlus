	...
	<div class="collapse navbar-collapse">
		...
		<ul _class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
			<div class="logindetails_container">
				...
				<div class="logindetails_container">Roshan<div>
				
                <!--start login panel -->
                <nav x-data="{ open: false }" _class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    <!-- Primary Navigation Menu -->
                    <div _class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div _class="flex justify-between h-16">
                            <div class="flex">
                                <!-- Logo -->
                            ...
                            <div _class="hidden sm:flex sm:items-center sm:ms-6">
                                <x-dropdown align="right" width="48">
                                    <x-slot name="trigger">
                                        <button _class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                                            <div>{{ Auth::user()->name }}</div>

                                            <div _class="ms-1">
                                                <svg _class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
